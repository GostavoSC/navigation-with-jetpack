...
import com.example.navigationwithjetpack.ui.MyItemRecyclerViewAdapter.BtnClickListener
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyItemRecyclerViewAdapter(DummyContent.ITEMS, object : BtnClickListener {
